 ...
 * Purpose of Class:
 */
public class MyOldSellListingsFragment extends Fragment {

    private static final String TAG = "NewSellListings";
    ...
    public static MyOldSellListingsFragment newInstance(UserProfile userProfile,
                                                        ArrayList<TextBook> textBooks) {
        MyOldSellListingsFragment fragment = new MyOldSellListingsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        TextView nothingSellListings = (TextView) view
                .findViewById(R.id.fragment_my_old_listings_nothing_text_view);
        nothingSellListings.setText(R.string.nothing_old_sell_listings);
