 ...
 * Purpose of Class:
 */
public class MyOldTradeListingsFragment extends Fragment {

    private static final String TAG = "OldTradeListings";
    ...
    public static MyOldTradeListingsFragment newInstance(UserProfile userProfile,
                                                        ArrayList<TextBook> textBooks) {
        MyOldTradeListingsFragment fragment = new MyOldTradeListingsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_my_old_listings, container, false);
        mNothingContainer = (PercentRelativeLayout) view
                .findViewById(R.id.fragment_my_old_listings_nothing_container);
        mProgressBar = (ProgressBar) view
                .findViewById(R.id.fragment_my_old_listings_progress);
        mRecyclerView = (RecyclerView) view.findViewById(R.id.fragment_my_old_listings_recycler);
        TextView nothingTradeListings = (TextView) view
                .findViewById(R.id.fragment_my_old_listings_nothing_text_view);
        nothingTradeListings.setText(R.string.nothing_old_trade_listings);
    ...
    public void onTextBooksRefreshed(ArrayList<TextBook> textBooks) {
        ...
        if (textBooks == null || textBooks.size() == 0) {
            ...
            mNothingContainer.setVisibility(View.GONE);
            mRecyclerView.setVisibility(View.VISIBLE);
            mRecyclerView.setAdapter(new MyListingsAdapter(textBooks, mClickListener, true, false));
        }
    }
