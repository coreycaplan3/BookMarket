 ...
 * Purpose of Class:
 */
public class MyNewSellListingsFragment extends Fragment implements OnRefreshListener {
    ...
    public static MyNewSellListingsFragment newInstance(UserProfile userProfile,
                                                        ArrayList<TextBook> textBooks) {
        MyNewSellListingsFragment fragment = new MyNewSellListingsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        nothingSellListings.setText(R.string.nothing_new_sell_listings);
    ...
    public void onTextBooksRefreshed(ArrayList<TextBook> textBooks) {
        ...
        if (textBooks == null || textBooks.size() == 0) {
            ...
            mProgressBar.setVisibility(View.GONE);
            mNothingContainer.setVisibility(View.GONE);
            mRecyclerView.setAdapter(new MyListingsAdapter(textBooks, mClickListener, true,
                    true));
        }
    ...
    public void onRefresh() {
        ...
        fragment.startGetNewSellListingsTask(mUserProfile);
    }
